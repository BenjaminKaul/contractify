 ...
 */
export interface RequestBody<REQUEST_BODY_TYPE extends RequestBodyType = RequestBodyType> {
 ...
 */
export type ExtractRequestBody<API> = API extends RequestBody ? API['body'] : undefined;
