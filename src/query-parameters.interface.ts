 ...
 */
export type ExtractQueryParameters<API> = API extends QueryParameters
  ? API['queryParameters']
  : undefined;
 ...
 */
export const hasQueryParameters = (api: any): api is QueryParameters =>
  'queryParameters' in api;
