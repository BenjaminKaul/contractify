 ...
 */
export type ContractFunctionFactoryOptions<REQUEST_OPTIONS extends RequestOptions = RequestOptions> = {
  /**
...
export class ContractFunctionFactory<REQUEST_OPTIONS extends RequestOptions = RequestOptions> {
   ...
   */
  create<API extends AtPath & UsesMethod>(api: API, requestOptions?: REQUEST_OPTIONS, baseUrl?: string) {
    return ((...args: any) => {
      const [
        pathParameters,
        queryParameters,
      ...
      if (ApiHelper.isRequestBodyApi(api)) {
        ...
        return methodFunction.call(this.httpClient, (baseUrl || this.baseUrl) + path, requestBody, {
          ...this.defaultOptions,
          ...requestOptions,
          ...options,
        ...
        return methodFunction.call(this.httpClient, (baseUrl || this.baseUrl) + path, {
          ...this.defaultOptions,
          ...requestOptions,
          ...options,
          [this.queryParameterKey]: queryParameters,
        ...
        throw new Error(`Unexpected http method ${api.method} => only supports GET | DELETE | PATCH | POST | PUT at the moment.`);
      }
