...
import { ExtractPathParameters, PathParameters } from "./path-parameters.interface";
import { ExtractQueryParameters, QueryParameters } from "./query-parameters.interface";
 ...
 */
export type ContractFunction<API extends AtPath & UsesMethod, REQUEST_OPTIONS = {}> = 
