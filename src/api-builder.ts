...
import { PathParameters, PathParametersType } from "./path-parameters.interface";
import { QueryParameters, QueryParametersType } from "./query-parameters.interface";
import { RequestBody, RequestBodyType } from "./request-body.interface";
import { Returns, ReturnsJSON, ReturnsRaw, ReturnsStream } from "./returns.interface";
...
export type ApiBuilder<API extends AtPath & UsesMethod> = {
   ...
   */
  queryParameters<QUERY_PARAMETERS extends QueryParametersType>(): ApiBuilder<API & QueryParameters<QUERY_PARAMETERS>>
} & {
  /**
   * Specify path parameters as an object of properties
   */
  pathParameters<PATH_PARAMETERS extends PathParametersType>(): ApiBuilder<API & PathParameters<PATH_PARAMETERS>>
} & {
  /**
   * Specify a request body as an object of properties
   */
  requestBody<REQUEST_BODY extends RequestBodyType>(): ApiBuilder<API & RequestBody<REQUEST_BODY>>
};
 ...
 */
export const constructApiBuilder = <API extends AtPath & UsesMethod & ({} | PathParameters | QueryParameters | RequestBody)>(api: API): ApiBuilder<API> => {
  return {
    /**
     * Specify a return type
     */
    returns: <RESULT_TYPE>() => merge(api, {
      result: {}
    } as Returns<RESULT_TYPE>),
    /**
     * Specify a json encoded return type
     */
    returnsJSON: <RESULT_TYPE>() => merge(api, {
      result: {},
     ...
     * Specify a raw return type
     */
    returnsRaw: <RESULT_TYPE extends string>() => merge(api, {
      result: {},
 ...
 * @param api API contract
 */
export const constructApiContract = <API extends AtPath & UsesMethod>(api: API) => {
...
export const API = {
   ...
   */
  get: <PATH extends string>(path: PATH) => constructApiContract({ method: HttpMethod.Get, path: path }),
  /**
   * Construct a DELETE contract
   * 
   * @param path Route path (including path parameters)
   */
  delete: <PATH extends string>(path: PATH) => constructApiContract({ method: HttpMethod.Delete, path: path }),
  /**
   * Construct a PATCH contract
   * 
   * @param path  Route path (including path parameters)
   */
  patch: <PATH extends string>(path: PATH) => constructApiContract({ method: HttpMethod.Patch, path: path }),
  /**
   * Construct a POST contract
   * 
   * @param path Route path (including path parameters)
   */
  post: <PATH extends string>(path: PATH) => constructApiContract({ method: HttpMethod.Post, path: path }),
  /**
   * Construct a PUT contract
   * 
   * @param path Route path (including path parameters)
   */
  put: <PATH extends string>(path: PATH) => constructApiContract({ method: HttpMethod.Put, path: path }),
};
